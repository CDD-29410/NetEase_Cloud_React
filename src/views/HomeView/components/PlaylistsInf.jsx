...
const PlaylistsInf = () => {
  ...
  const listsInf = [
    {
      ...
      context: ListsInf?.shareCount,
    },
    {
      icon: "iconamoon:comment-dots-fill",
      context: ListsInf?.commentCount,
    },
    {
      icon: "solar:calendar-add-bold",
      context: Math.round(ListsInf?.subscribedCount / 10000) + "万",
    },
  ];
  ...
  return ListsInf ? (
    <div style={{ backgroundColor: color }} className=" pt-[3vw]">
      <div className="w-[100vw] sticky top-0">
        <div
      ...
      {/* 上半部分 */}
      <div className="">
        <div className=" flex justify-between mt-[5vw] px-[3vw]">
          <div className="flex">
            <img
            ...
            <div className="ml-[3vw] flex flex-col">
              ...
              <div className="flex  items-center mt-[2.5vw] ">
                ...
                <div className="text-[2.3vw] opacity-60 text-[#C4C3CB] ml-[1vw] w-[11vw] h-[5vw] leading-[5vw] bg-[#7B7A82] text-center rounded-[2.5vw]">
              ...
              <div className="mt-[2.2vw] flex ">
                {ListsInf.tags.map((item, index) => (
                  <div
                    className="mr-[2vw] px-[1.4vw] opacity-60 h-[4vw] bg-[#84878E] flex items-center justify-evenly rounded-[1vw] "
                    key={index}
                  >
                    <span className="text-[2.3vw] text-[#F0EFF7]">{item}</span>
                    <Icon
          ...
          <Icon
            ...
            width="3vw"
            height="3vw"
            className="w-[5vw] h-[5vw]  bg-[#787A81] rounded-[50%] "
          />
        </div>
        ...
        <ul className="flex items-center overflow-hidden justify-between mt-[4.4vw] px-[3vw]">
          {listsInf.map((item, index) => (
            <div
              ...
              className="w-[28.6vw] h-[10vw] text-center leading-[10vw] rounded-[5vw] opacity-80 bg-[#999] flex items-center justify-center"
            >
      ...
      {/* 下半部分 */}
      <div className="mt-[4.5vw] pt-[3vw] opacity-70  bg-gradient-to-b  from-[#E0E0E1] to-[#fff] rounded-t-[2vw]">
        <div
